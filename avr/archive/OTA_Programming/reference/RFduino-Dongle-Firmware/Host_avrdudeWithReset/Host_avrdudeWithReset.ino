...
device_t role = HOST;  // This is the HOST code!  that connects to the PC/Mac
...
char resetMessage[1];          // message sent to DEVICE telling it to set or clear it'us own GPIO6
