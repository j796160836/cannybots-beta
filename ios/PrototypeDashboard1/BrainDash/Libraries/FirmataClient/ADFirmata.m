...
#import "ADFirmata.h"
#import "ADBlueFruitSerialPort.h"
...
+(ADArduino*) sharedArduino {
    ...
    dispatch_once(&onceToken, ^{
        ...
        id<ADSerialPort> defaultSerial = [[ADBlueFruitSerialPort alloc] initWithDevice:DEFAULT_SERIAL baudRate:DEFAULT_BAUDRATE timeout:DEFAULT_TIMEOUT];
